...
import { EmbedSelector } from "@/app/ui-components/EmbedSelector.component";
		...
		<main className="relative min-h-screen">
			...
			<div className="relative z-10 container mx-auto px-4 py-16 md:py-24 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
				<div className="flex flex-col items-center lg:items-start gap-8">
					...
					<div className="w-full flex flex-col gap-4 text-white text-center lg:text-left">
						...
						<div className="flex items-center justify-center lg:justify-start gap-4">
							...
							<span className="text-neutral-300">{`${Math.floor(
								movie.runtime / 60,
				...
				<div className="flex flex-col gap-8">
					<div>
						<h2 className="flex w-1/4 mx-auto text-center text-2xl font-semibold mb-4 border-b-2 border-blue-500/50 pb-2 justify-center">
							Assistir Agora
						</h2>
						<EmbedSelector
							id={movie.id}
